layui.define(function(exports) {
	layui.use(['echarts','global'], function() {
		...
		var data_type_1 = $('#device_type_1');
		$(data_type_1[0]).css('height','440px');
		var echarts_type_1 = echarts.init(data_type_1[0], layui.echartsTheme);
		...
		echarts_type_1.setOption(options_type_1);
		
		window.onresize = echarts_type_1.resize;
	})
